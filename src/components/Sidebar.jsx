...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-gradient-to-b from-white to-rose-50/30 shadow-xl border-r border-rose-100/50 h-screen sticky top-0 flex flex-col overflow-hidden">
      {/* Header Section */}
      ...
      <nav className="flex-1 overflow-y-auto p-4 space-y-1 
        ...
        [&::-webkit-scrollbar-track]:bg-gradient-to-b [&::-webkit-scrollbar-track]:from-rose-50/30 [&::-webkit-scrollbar-track]:to-amber-50/30
        [&::-webkit-scrollbar-track]:rounded-full
        [&::-webkit-scrollbar-thumb]:bg-gradient-to-b [&::-webkit-scrollbar-thumb]:from-rose-300 [&::-webkit-scrollbar-thumb]:to-rose-400
        [&::-webkit-scrollbar-thumb]:rounded-full
        [&::-webkit-scrollbar-thumb]:border-2 [&::-webkit-scrollbar-thumb]:border-white/30
        hover:[&::-webkit-scrollbar-thumb]:from-rose-400 hover:[&::-webkit-scrollbar-thumb]:to-rose-500
      ...
      <div className="p-4 flex-shrink-0">
        <div className="bg-gradient-to-br from-amber-400 via-rose-400 to-rose-500 rounded-2xl p-4 text-white shadow-xl">
          ...
          <button className="w-full bg-white/20 backdrop-blur-sm text-white text-xs font-semibold py-2 rounded-lg hover:bg-white/30 transition-all duration-300 border border-white/20">
            Upgrade Now
          </button>
        </div>
      </div>
