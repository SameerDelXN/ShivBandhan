...
export default function AppDownloadSection() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-orange-50 py-20 lg:px-20">
      {/* Decorative elements */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-orange-200/50 blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full bg-amber-200/30 blur-3xl"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`max-w-lg transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="inline-block mb-4">
              <span className="px-4 py-1 rounded-full bg-orange-100/70 text-orange-800 text-sm font-medium border border-orange-200/50">
                Mobile Experience
              </span>
            </div>
            
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
              Find Your Perfect Match <span className="text-orange-600">Anytime, Anywhere</span>
            </h2>
            ...
            <div className="flex items-center mb-8">
              ...
              <span className="text-gray-600 ml-1">• 10k+ Reviews</span>
            </div>
            
            {/* Download buttons */}
            <div className="flex flex-col sm:flex-row gap-4">
              {/* App Store Button */}
              <button className="px-6 py-3 bg-white rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-lg flex items-center justify-center group border border-orange-200/50">
            ...
            <div className="mt-8 flex items-center">
              <div className="w-16 h-16 bg-white p-1 rounded-lg shadow-lg mr-4 border border-orange-200/50">
                <Image
                  width={1920}
                  height={1080} 
                  src="/qr.png" 
              ...
              <div>
                <p className="text-gray-700 text-sm">Or scan QR code</p>
                <button className="flex items-center text-orange-600 text-sm font-medium mt-1 hover:text-orange-700 group">
          ...
          <div className={`flex justify-center transition-all duration-1000 delay-300 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="relative">
              ...
              <div className="absolute top-20 -left-16 z-20 hidden lg:block">
                <div className="bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-lg flex items-center space-x-3 transform -rotate-6 border border-orange-200/50">
              ...
              <div className="absolute bottom-20 -left-8 z-20 hidden lg:block">
                <div className="bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-lg flex items-center space-x-3 transform rotate-3 border border-orange-200/50">
              ...
              {/* Decorative elements */}
              <div className="absolute -z-10 -bottom-10 -left-10 w-40 h-40 rounded-full border-8 border-orange-200/40 opacity-60"></div>
              <div className="absolute -z-10 top-10 right-10 w-24 h-24 rounded-full border-8 border-amber-200/30 opacity-50"></div>
            </div>
          </div>
        </div>
      </div>
