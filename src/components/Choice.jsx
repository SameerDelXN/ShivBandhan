      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 w-full flex items-center justify-center text-center mb-12">
            <img src="/assest/kalash.png" alt="lotus" className="w-12 sm:w-16 md:w-20" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mt-12">
            {features.map((feature, index) => (
              ...
              >
                <div className="relative overflow-hidden bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 h-full border border-orange-200/50 group">

                  {/* Quarter circle */}
                  <div className="absolute -top-10 -right-10 w-25 h-25 rounded-full bg-gradient-to-br from-orange-400 to-amber-400 opacity-20 transition-all duration-300 group-hover:w-32 group-hover:h-32"></div>

                  {/* Icon */}
                  <div className={`relative w-16 h-16 rounded-xl bg-gradient-to-r ${feature.color} flex items-center justify-center mb-6 shadow-lg`}>
