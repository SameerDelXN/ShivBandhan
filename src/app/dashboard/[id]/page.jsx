    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50/50 via-white to-amber-50/30 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 transform transition-all duration-1000 delay-200 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-orange-100/50 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full bg-orange-50 text-orange-600 py-2 rounded-lg text-sm font-medium hover:bg-orange-100 transition-colors">
                Complete Profile
              </button>
            </div>
          </div>
          ...
          {/* Subscription Status */}
          <div className="bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl p-6 shadow-lg text-white">
            <div className="flex items-center justify-between mb-4">
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-6 transform transition-all duration-1000 delay-300 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          ...
          {/* My Profile Card */}
          <div className="lg:col-span-1 bg-white rounded-xl p-6 shadow-lg border border-orange-100/50 flex items-center justify-center">
            <div className="text-center">
              ...
              <button className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-2 rounded-lg font-medium hover:from-orange-600 hover:to-orange-700 transition-all duration-300">
                Edit Profile
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-lg border border-orange-100/50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {quickMatches.map((match) => (
                <div key={match.id} className="border border-gray-200 rounded-lg p-4 hover:border-orange-300 hover:shadow-md transition-all duration-300">
                  ...
                  <div className="flex space-x-2">
                    <button className="flex-1 bg-orange-50 text-orange-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-orange-100 transition-colors">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-orange-100/50">
            ...
            <div className="space-y-4">
              {recentActivity.map((activity, index) => {
                ...
                return (
                  <div key={index} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-orange-50/50 transition-colors">
        ...
        <div className={`transform transition-all duration-1000 delay-500 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          <div className="bg-gradient-to-r from-orange-500 to-amber-500 rounded-xl p-6 text-white shadow-xl">
