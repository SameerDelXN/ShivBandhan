    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          <button 
            className="bg-rose-500 hover:bg-rose-500 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-1"
            onClick={() => {
              setEditingPlan(null);
              setNewPlan({
                name: "",
       ...
       >
            <div className="p-5">
                    ...
                    <div className="mt-2 space-y-1 max-h-32 overflow-y-auto">
                      {newPlan.features.map((feature, index) => (
                        <div key={index} className="flex justify-between items-center bg-gray-50 p-2 rounded text-sm">
                          ...
                          <button 
                            className="text-rose-500 hover:text-rose-500 ml-2"
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  className="px-4 py-2 bg-rose-500 hover:bg-rose-500 text-white rounded-lg text-sm"
